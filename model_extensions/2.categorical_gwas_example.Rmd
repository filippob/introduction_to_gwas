...
```{r sheep}
sheep <- fread("../../categorical_gwas/data/sheep_reduced.raw")
sheep <- dplyr::select(sheep, -c(FID,PAT,MAT,SEX,PHENOTYPE))
phenotypes <- fread("../../categorical_gwas/data/sheep_phenotypes.txt", header = TRUE)
...
```{r}
snp_map <- fread("../../categorical_gwas/data/sheep_reduced.map")
