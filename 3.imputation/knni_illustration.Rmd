...
<span style="color:red">!! remember to **download the data** for this practical sessions: http://www.jackdellequerce.com/data/GenRiz44.txt !!</span>

<span style="color:red">!! you should download the data into the data/ folder inside the introduction_to_gwas repository !!</span>
